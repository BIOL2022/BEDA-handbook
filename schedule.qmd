...
**You can download the entire set of lecture slides [here](#) as a single ZIP file.** Learn how to uncompress ZIP files on [Windows](https://support.microsoft.com/en-au/windows/zip-and-unzip-files-8d28fa72-f2f9-712f-67df-f80cf89fd4e5) or [Mac](https://support.apple.com/en-au/guide/mac-help/mchlp2528/mac).
...
schedule_processed <- schedule_data_raw |>
  ...
  mutate(
    Week = sprintf("**Week %02d** %s", Week_Num, Dates_Str)
  ) |>
