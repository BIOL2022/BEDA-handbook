...
- [Introduction to Module 3](301-intro.qmd)
...
1. **Group Data Submission (Excel File)**
   ...
   Make sure the file is clearly organised, with each dataset on a separate worksheet or in separate files, and correctly formatted for analysis in **Jamovi**.
...
1. Import your data. [**Download it here**](https://canvas.sydney.edu.au/courses/67437/pages/module-3-resources). If the link does not work, please go on to [Canvas](https://canvas.sydney.edu.au/courses/67437). A new **Module 3 Resources** link has been added to the front page.
   - Open **Jamovi**.
...
![Video showing how to load the Week 9 data file in Jamovi.](assets/w09-jamovi-load-data.mp4)
...
![Video showing how to open the PCA analysis in Jamovi.](assets/w09-jamovi-run-pca.mp4)

4. Descriptive statistics and suitability tests
   - Under **“Assumption Checks”**, tick the box for **Bartlett’s Test of Sphericity** (to check if your data is suitable for PCA).

5. Extraction settings
   - Select **“Based on eigenvalue”** so that components with **eigenvalues > 1** (Kaiser’s criterion) are retained. Change this only if you have a specific reason to do so.
   - Tick **Scree Plot**.
   - Tick **Unrotated solution**.

6. Rotation
   - In the **“Rotation”** section, choose **Varimax** rotation (this is the most common rotation method).
   - Tick **Display Rotated Solution**.

![Video showing the Jamovi PCA options to select.](assets/w09-jamovi-pca-options.mp4)
...
## Week 10 group presentation (compulsory)
