---
title: "**Week 11**: Multivariate methods in biology (continued)"
---
...
67. Appropriate outputs for your community structure analyses
   - nMDS (saved as suitable image file)
   - PERMANOVA results (in rtf/doc file)
   - SIMPER if justified
68. Appropriate outputs for your PCA
   - File with Jamovi or R output
69. Univariate tests using your PCA results
   - File with Jamovi or R output with Regression and/or ANOVA results (testing hypotheses using your newly derived PCs)
...
If you don’t complete your analyses, I will make the program available to you outside of prac times. There will also be time in week 13 to do any extras.
