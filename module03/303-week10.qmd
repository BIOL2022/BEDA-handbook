...
![Example Jamovi-ready data sheet layout for PCA.](assets/image1.png){fig-alt="Spreadsheet layout showing a Jamovi-ready data sheet for PCA."}

#### **Example of data sheet for importing data into PRIMER**

 ![Example PRIMER-ready data sheet layout.](assets/image2.png){fig-alt="Spreadsheet layout showing a PRIMER-ready data sheet."}
