...
The main program we will use in this course is **Jamovi**. However, if you prefer working in **R**, complete **R scripts (RStudio files)** for all the methods covered will be made available on **Canvas**.
...
We will primarily use the **MISO module in Jamovi** for these analyses, although equivalent **R** code will also be provided.
