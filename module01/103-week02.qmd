...
The BIOL2022 snail-collecting competition remains open until the end of Week 4. You can return snails on any day the BIOL2022 laboratories are running, so check the current laboratory schedule on Canvas before coming in.

Read the [snail collection and care guide](https://canvas.sydney.edu.au/courses/74353/pages/snail-collecting-competition) before collecting anything. The current competition and prize details will be provided on Canvas.
