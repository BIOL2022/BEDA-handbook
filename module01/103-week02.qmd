...
Today we focus on **study design and sampling**. You will work in groups of at least four to agree on a clear plan for collecting data in the next practical.

**Spend 2 to 3 minutes now looking at the image below.** What do you see? If you notice something, how would you propose to measure it? If there are things that you need to identify, how would you go about doing that? Questions like these are the first step in designing a study and help determine whether data can be collected reliably and consistently due to logistical constraints.

![An image from the [Eindhoven Wildflower Dataset](https://doi.org/10.34894/U4VQJ6), Schouten, Michielsen & Gravendeel (2024), DataverseNL, licensed under [CC BY 4.0](https://creativecommons.org/licenses/by/4.0/).](assets/urban-wildflowers.jpg){fig-alt="Top-down view of a woodland floor covered by divided green foliage, scattered white nodding flowers, and brown leaf litter; no scale or quadrat is visible."}
...
4. Have a look through the [study-design](https://docs.google.com/document/d/1JhSevrzpLlDsD0a4225h_dcC4i5ZOII7dkTr8u4gCgs/edit#heading=h.rc1vfwuebyac) template that your supervisor cobbled up. You will use it in the practical as a scaffold.
...
In this short workshop, we will explore how to sample data from a site. It would be nice if we were there, but today we can only pretend to be on site as few of us are ready to work in the field just yet. You will consider counts, presence or absence, cover, and other measurements.
