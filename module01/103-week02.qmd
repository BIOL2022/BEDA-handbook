...
## Workshop
The Week 2 workshop will go through **Tidy data principles**. Tidy data is a way of structuring your data so that it is easy to work with and analyse. It is a key principle in data analysis and will help you avoid common pitfalls when working with data. [Go to workshop 02](w02-tidy-data.qmd).
...
Access the images, including background information, [here](/module01/105-images.qmd){target="_blank" rel="noopener noreferrer"} (note: link will open in a new window/tab).
:::
