---
title: "Workshop 2: tidy data"
author: Januar Harianto
resources:
  - assets/lotr.xlsx
  - assets/ferret.xlsx
  - assets/fish_station.csv
---
...
[lotr.xlsx](assets/lotr.xlsx) |
[ferret.xlsx](assets/ferret.xlsx) |
[fish_station.csv](assets/fish_station.csv)
...
```{r}
#| echo: false
possums <- readxl::read_excel("assets/possums.xlsx", sheet = 2) |>
  select(Sex, BW)
possums |>
  head(8) |>
  gt() |>
...
**The above rules means that you need a clear understanding of what a variable, observation and value are.**
