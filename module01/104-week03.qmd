...
Today, you will be collecting data based on your final sampling design from last week and then performing data analysis on the data you collected.

## Before the practical

- Check out the lecture on modelling assumptions. You will apply it to your model today (if possible).


## Preparation (Module 2)

Module 2 will introduce you to project-based experimental design. Before this practical, read the [Report 1 project descriptions](../module02/203-projects.qmd) and identify three projects that interest you.

The first five minutes of today's practical are reserved for confirming your preferences:

1. Choose a first, second, and third project preference.
2. Submit your preferences through the Canvas project-preference activity.
3. Choose a project, **not a specific group**. Staff will allocate students to projects within the available capacity and then create balanced Canvas groups.

Project capacity is a hard limit. If a project is oversubscribed, staff will use the ranked preferences and a random tie-break rather than submission order. Read the project descriptions before class so that you can complete this activity quickly.

This project-preference activity is separate from today's data-analysis group. You will continue working with the same groups as last week for the practical below.
...
2. Bring your laptop and the necessary software (e.g., R, Jamovi) installed for data analysis. See the [Week 1 software reference](102-week01.qmd#software-reference-use-outside-the-timed-class) for installation instructions.
...
The Workshop 3 resource linked above is a hands-on preview of running models in both R and Jamovi.

## Lab activity

### Google Drive

[Open the shared Google Drive folder](https://drive.google.com/drive/folders/1rDyHyzgTVWUmPEzNte0F1CgVb3_Eitlk?usp=drive_link).
...
::: {.column-margin}
<i class="bi bi-info-circle me-1" aria-hidden="true"></i> Violation of the normality assumption is often ignored when sampling is large, as the Central Limit Theorem suggests that the sampling distribution of the mean will be normally distributed regardless of the shape of the population distribution.
:::
...
[Download cats.xlsx](assets/cats.xlsx)
...
[Download cherry.xlsx](assets/cherry.xlsx)
...
### (**Extra challenge**) effects of dietary protein on pigs

[Download pigs.xlsx](assets/pigs.xlsx)
...
### (**Extra challenge**) Sugar cane disease data

[Download cane.xlsx](assets/cane.xlsx)
...
Once complete, please upload your results to the Google Drive folder provided in class for archival. If there's time, we will discuss the results together.
