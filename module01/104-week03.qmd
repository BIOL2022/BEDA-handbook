...
1. [**Review Lecture 3a**](https://biol2022.github.io/2026-lectures/lectures/L03a-model-appropriate/index.html). It covers the model assumptions and diagnostics that you will apply today. Please review it before the practical.
...
Download the [group-charter template](assets/word/group-charter-template.docx).
