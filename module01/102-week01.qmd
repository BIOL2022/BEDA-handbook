...
- Data: [penguins.csv](https://canvas.sydney.edu.au/files/44247073/download?download_frd=1&verifier=Dlxf3Nix6XHMgS07tA93Z7KpcilKMwDkVQNvuxgR) and [possums.xlsx](https://canvas.sydney.edu.au/files/44247072/download?download_frd=1&verifier=NFLXvOu0pMFrVUhXaQIaVNEOPFOKbU6EFdSNrKnf) (grab them from Canvas)
...
This section is for those who finish early or would like extra practice at home. Use the `penguins` and `possums` datasets from this practical.
