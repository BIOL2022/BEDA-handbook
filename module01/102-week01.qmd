...
- [Workshop 1: Software](w01-intro.qmd)
...
The Workshop 1 resource linked above covers:
...
#| fig-alt: "Boxplot comparing simulated animal weight for young and old age groups."
#| code-fold: true
#| warning: false
...
#| fig-alt: "Scatterplot of simulated animal weight by age with an upward fitted trend line."
#| code-fold: true
