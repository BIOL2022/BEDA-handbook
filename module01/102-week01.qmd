...
5. Open RStudio and run `install.packages(c("tidyverse", "vegan", "car"), repos = "https://cloud.r-project.org")` in the R console to install the required packages.
...
5. Run `install.packages(c("tidyverse", "vegan", "car"), repos = "https://cloud.r-project.org")` in the R console to install the required packages.
...
That's it for today! If you have any questions, ask your demonstrators who are happy to help. We will do a 10-minute Q&A session before showing the attendance QR code. Make sure to take attendance as it is a compulsory component (80% attendance required to pass the course).
