...
- Download R [here](https://cran.rstudio.com/){target="_blank" rel="noopener noreferrer"}.
- Download RStudio Desktop from [here](https://posit.co/download/rstudio-desktop/){target="_blank" rel="noopener noreferrer"}.
- If necessary, you may sign up to RStudio Cloud [here](https://posit.cloud/){target="_blank" rel="noopener noreferrer"}. This applies to those who have trouble installing R and RStudio on their computer, and still prefer this to the other software options.
...
- Alternatively, you can use the University's [Citrix Workspace](https://uniconnect.cloud.com/Citrix/StoreWeb/#/login){target="_blank" rel="noopener noreferrer"} to access SPSS. Note that using Citrix is not a common solution for statistical software. Your demonstrators are *not* trained in Citrix, so they will probably need to troubleshoot with you to get it working.

While I do not use SPSS myself, we do provide support for it in BEDA. It is somewhat of a mixed bag at present, as it has R integration, is point-and-click, and also has a syntax editor for scripting analyses. If you would prefer not to use Citrix, [PSPP](https://www.gnu.org/software/pspp/){target="_blank" rel="noopener noreferrer"} is an excellent free alternative to SPSS. It has a very similar interface and syntax, and because it is free software, it will not expire or require separate licences for advanced features.
