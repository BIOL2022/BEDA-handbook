...
| [**P06**](#p06) | Native or horticultural germination<br>Germination experiment | Requires carefully controlled conditions and regular care of plants over time. You can switch to P05 if germination fails. |
...
::: {.project-section}
#### **🌧️🌾 Project P05** – Germination and growth of wheat in relation to water availability {#p05}
<br>
...
::: {.project-section}
#### **🪻🥬 Project P06** – Germination of native grass seeds OR a horticultural plant (flower or veggie) in relation to water availability {#p06}
<br>
