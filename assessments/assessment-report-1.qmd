...
3. Submit your report anonymously via Canvas by **Friday 25 September 2026 at 23:59 (end of Week 8),** using the filename format "Day-Time-Project-Your SID" (e.g., "WED2-4pmProj4A-123456789").
...
7. **Write the entire report in your own words; include a statement about whether and how you used AI (or state that you did not use AI).** You must NOT upload your data set to any AI platform, and you must analyse your data yourself — tutors and demonstrators will ask each of you to show them your statistical analysis in prac class (see the [Report 1 instructions](../module02/204-report1.qmd) for the full conditions).
