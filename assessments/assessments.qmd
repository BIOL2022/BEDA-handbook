...
[Details](assessment-eft.qmd){.btn .btn-primary} [Submission link](https://canvas.sydney.edu.au/courses/74353/assignments/696326){.btn .btn-success}
:::
...
[Details](assessment-evaluation-quiz.qmd){.btn .btn-primary} [Submission link](https://canvas.sydney.edu.au/courses/74353/assignments/696327){.btn .btn-success}
:::
...
- [Explore the Report 1 project options](../module02/203-projects.qmd)
- [Read the Report 1 instructions](../module02/204-report1.qmd)
- [Open the Report 1 marking rubric](../module02/206-rubric.qmd)

<p><strong>Report due:</strong> <span id="countdown-report1"></span></p>
[Details](assessment-report-1.qmd){.btn .btn-primary} [**Data** submission](https://canvas.sydney.edu.au/courses/74353/assignments/696330){.btn .btn-success} [**Report** submission](https://canvas.sydney.edu.au/courses/74353/assignments/696331){.btn .btn-success}
:::

::: {.assessment-section}
## <i class="bi bi-file-earmark-bar-graph"></i> Report 2 (Module 3) - 20%
**Due:** 21-24 October 2025 (dataset submission) | 7 November 2025 (report)
...
<p><strong>Dataset submission</strong><br>
*Due at 10am on the day of your laboratory*:<br>
**Tue groups**: <span id="countdown-report2-dataset-tue"></span><br>
**Wed groups**: <span id="countdown-report2-dataset-wed"></span><br>
**Fri groups**: <span id="countdown-report2-dataset-fri"></span><br>
<strong>Report due:</strong> <span id="countdown-report2"></span></p>
[Details](assessment-report-2.qmd){.btn .btn-primary} [**Data** submission](https://canvas.sydney.edu.au/courses/74353/assignments/696332){.btn .btn-success} [**Report** submission](https://canvas.sydney.edu.au/courses/74353/assignments/696333){.btn .btn-success}
:::
...
<script>
  document.addEventListener('DOMContentLoaded', function() {
    ...
    startCountdown('2025-10-21T10:00:00', 'countdown-report2-dataset-tue');
    startCountdown('2025-10-22T10:00:00', 'countdown-report2-dataset-wed');
    startCountdown('2025-10-24T10:00:00', 'countdown-report2-dataset-fri');
